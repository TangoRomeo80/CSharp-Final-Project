...
namespace WalletBuddy.DB
{
  class ExpenseDataAccess : DataAccess
  {
    ...
    {
      string query = "SELECT * FROM EXPENSE_TBL WHERE USER_ID= '" + user.UserId + "'";
    ...
    {
      string sql = "INSERT INTO EXPENSE_TBL(USER_ID,AMOUNT,PAYMENT_TO,DESCRIPTION,ACCOUNT_NAME,DATE) VALUES('" + expense.UserId + "','" + expense.Amount + "','" + expense.PaymentTo + "','" + expense.Description + "','" + expense.AccountName + "','" + expense.Date.ToString("yyyy-MM-dd HH:mm:ss.fff") + "')";
